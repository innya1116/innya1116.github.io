...
skt_landing.action = {
    ...
    gnb : function(){
        ...
        // });
         ...
         /* 211029 2022년 앱웹접근성 샘플링 심사 결과 반영 1차 START */
        $('.bt-depth1 .more').attr('aria-pressed', 'false');
        $('.bt-depth1 .more').on('click', function(e){
            if($(this).parent().next().is('.depth2')){
                $(this).parent().parent().toggleClass('open');
        ...
        $('.tod-gnb-ctl-wrap > button.btn').on('click', function (e) {
            ...
            var isOpen = $(this).hasClass('all-open');
            if(isOpen){
                $('.bt-depth1 .more').attr('aria-pressed', 'true');
            }else{
                $('.bt-depth1 .more').attr('aria-pressed', 'false');
            }
         ...
         /* 211029 2022년 앱웹접근성 샘플링 심사 결과 반영 1차 END */
    },
    /**
